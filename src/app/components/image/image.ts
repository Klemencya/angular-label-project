...
@Component({
    ...
    template: `
      <span [ngClass]="containerClass()" [class]="styleClass" [ngStyle]="style">
            <img [attr.src]="src" [attr.alt]="alt" [attr.width]="width" [attr.height]="height" [ngStyle]="imageStyle"
                 [class]="imageClass"/>
            <div class="p-image-preview-indicator" *ngIf="preview" (click)="expandPicture()">
            ...
            <div #mask class="p-image-mask p-component-overlay p-component-overlay-enter" *ngIf="maskVisible"
                ...
                <div *ngIf="previewVisible"
                    ...
                    <img [attr.src]="src" class="p-image-preview" [ngStyle]="imagePreviewStyle()"
...
export class Image implements AfterContentInit {
    ...
    constructor(private config: PrimeNGConfig, private cd: ChangeDetectorRef, private dialogService: DialogService) { }
